...
Both are published from **`972b6e8`** (#58, #59): play at **version 24**, concept at
**version 20** — no force needed, the same session having published 23 and 19 from `46b443c`.
